...
class vkLog {
	...
	replyMessage(data) {
		let { replyId, attachmentType, senderId, sName, outbox, replyMessage } = data;
		...
		let content = attachmentType?
						"<span class='im-page-pinned--media'>Голосовое сообщение</span>":
						// "<span class='im-page-pinned--media'>Голосовое сообщение</span>":	// Тут i или span с классом типа вложения
...
templateReplyMessage = `
	<div class="im-mess--text" title="[{RPLY:RepliedMessageID}]">
		...
		<div class="im-replied _im_replied_message" onclick="document.getElementById('mid{RPLY:RepliedMessageID}').scrollIntoView();">
